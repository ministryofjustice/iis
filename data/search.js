...
module.exports = {
    ...
    inmate: function(userInput, callback) {
        ...
        let sql = "SELECT PK_PRISON_NUMBER, UPPER(INMATE_SURNAME) INMATE_SURNAME, UPPER(LEFT(INMATE_FORENAME_1,1))+LOWER(SUBSTRING(INMATE_FORENAME_1,2,LEN(INMATE_FORENAME_1))) INMATE_FORENAME_1, UPPER(LEFT(INMATE_FORENAME_2,1))+LOWER(SUBSTRING(INMATE_FORENAME_2,2,LEN(INMATE_FORENAME_2))) INMATE_FORENAME_2, FORMAT(INMATE_BIRTH_DATE,'dd/MM/yyyy') AS DOB, ";
        // eslint-disable-next-line
