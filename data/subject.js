...
module.exports = {
    details: function (id, callback){
        ...
        var sqlWhere = "PK_PRISON_NUMBER = @PK_PRISON_NUMBER",
            sql = "SELECT PK_PRISON_NUMBER, INMATE_SURNAME, INMATE_FORENAME_1, INMATE_FORENAME_2, FORMAT(INMATE_BIRTH_DATE,'dd/MM/yyyy') AS DOB, DATEDIFF(year, INMATE_BIRTH_DATE, GETDATE()) AS AGE FROM IIS.LOSS_OF_LIBERTY WHERE " +  sqlWhere + ";",
